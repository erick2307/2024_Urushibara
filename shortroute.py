...
#read data
Nodesdf = pd.read_csv('./Input/nodes.csv',names=["#number","Coord_x","Coord_y","Evacuation","Reward"],skiprows=1)
Edgesdf = pd.read_csv('./Input/edges.csv',names=["#number","Node1","Node2","Length",'Width'],skiprows=1)
...
data.to_csv('./Input/nextnode.csv',index=False)
